 ...
 * @author DELL
 */
@WebServlet(name = "UpdateDeleteAccount", urlPatterns = {"/updateaccount"})
public class UpdateDeleteAccount extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("update")) {
            ...
            String role_ = request.getParameter("role_id");
            String status_ = request.getParameter("status");
            int role_id = Integer.parseInt(role_);
        ...
        if (action.equals("delete")) {
            ...
            if (role_id == 4) {
                ...
                return;// xoa luôn doctor vì đã xóa tài khoản thì mất luôn cả email , pass user name
            }
            u.deleteAccountByAdmin(username);
            request.setAttribute("deleteAccountOK", "deleteAccountOK");
