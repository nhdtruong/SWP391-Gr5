...
public class MyFeedback extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        var user = (AccountUser)session.getAttribute("user");
        DoctorDAO doctorDAO = new DoctorDAO();
        var doctor_id = doctorDAO.getDoctorIdByDoctorUsername(user.getUsername());
        RateStarDAO rateStarDAO = new RateStarDAO();
        
        var rate = rateStarDAO.getAllRateStarByDoctorId2(doctor_id);
        
        request.setAttribute("ratelist", rate);
