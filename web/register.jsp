                                ...
                                <form action="register" method="POST" class="login-form mt-4" onSubmit="document.getElementById('submit').disabled=true;">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input value="${requestScope.password}" type="password" id="password"  class="form-control" name="password" required="">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3" style="position: relative">
                                            ...
                                            <input value="${requestScope.repassword}" type="password"  class="form-control" name="repassword" required="">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="d-grid">
