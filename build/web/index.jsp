                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 mt-4 pt-2" style="" >
                            <div class="card team border-0 rounded shadow overflow-hidden">
                                ...
                                <div class="card-body content text-center">
                                    <a href="#" class="title text- h5 d-block mb-0">${s.getName()}</a>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 mt-4 pt-2">
                            <div class="card team border-0 rounded shadow overflow-hidden">
                                <div class="team-img position-relative">
                                    <img src="${d.getImg()}" style="display: block;margin-left: auto;margin-right: auto;" class="rounded img-fluid" alt="">
                                </div>
                                <div class="card-body content text-center">
                                    <c:if test="${d.getAcademicTitle().getName().isEmpty() && d.getAcademicDegree().getName().isEmpty()}">
                                    <a href="doctor?action=detail&id=" class="title text- h5 d-block mb-0">${d.getPosition().getName()}.${d.getDoctor_name()} </a>
                                    <small class="text-muted speciality">${d.getPosition().getName()}</small>
                                    </c:if>
                                    <c:if test="${d.getAcademicTitle().getName().isEmpty() && !d.getAcademicDegree().getName().isEmpty()}">
                                    <a href="doctor?action=detail&id=" class="title text- h5 d-block mb-0">${d.getAcademicDegree().getName()}.Bác sĩ.${d.getDoctor_name()} </a>
                                    <small class="text-muted speciality">${d.getPosition().getName()}</small>
                                    </c:if>
                                    <c:if test="${!d.getAcademicTitle().getName().isEmpty() && !d.getAcademicDegree().getName().isEmpty()}">
                                    <a href="doctor?action=detail&id=" class="title text- h5 d-block mb-0">${d.getAcademicTitle().getName()}.${d.getAcademicDegree().getName()}.${d.getDoctor_name()} </a>
                                    <small class="text-muted speciality">${d.getPosition().getName()}</small>
                                    </c:if>
                                    <c:if test="${!d.getAcademicTitle().getName().isEmpty() && d.getAcademicDegree().getName().isEmpty()}">
                                    <a href="doctor?action=detail&id=" class="title text- h5 d-block mb-0">${d.getAcademicTitle().getName()}.${d.getDoctor_name()} </a>
                                    <small class="text-muted speciality">${d.getPosition().getName()}</small>
                                    </c:if>
                                </div>
                            </div>
