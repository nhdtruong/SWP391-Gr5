    ...
    <div class="sidebar-content" data-simplebar style="height: calc(100% - 60px);">
        ...
        <ul class="sidebar-menu pt-3">
            <c:if test="${sessionScope.user.getRole()== 1}">
                ...
                <li><a href="accountmanager"><i class="uil uil-user me-2 d-inline-block"></i>Quản lý Tài khoản</a></li>
                <li><a href="doctormanager"><i class="uil uil-user me-2 d-inline-block"></i>Quản lý Bác sĩ</a></li>
